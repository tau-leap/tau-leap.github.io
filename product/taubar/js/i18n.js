const STRINGS = {
  en: {
    ...
    'feat.taskbarBody': 'On Windows you switch by window title.\nDock groups everything by app.\nTauBar puts each open window on the bar, so you can find it by its title.',
    'feat.pin': 'Pin apps to the taskbar',
    'feat.pinBody': 'Pin apps left or right on the taskbar —\nthe same habit you had on Windows.',
    ...
    'pricing.sub': 'Spend 10 days with the familiar workflow. After that, keep Free forever or unlock Pro with a subscription or lifetime license.',
    'compare.title': 'Free vs Pro',
    'compare.freeLabel': 'Free',
    'compare.freeNote': 'After the trial, without a purchase. Core taskbar stays available.',
    ...
    'compare.pro2': 'System action icons, unread badges, Chrome profiles',
    'compare.pro3': 'Media controls',
    'compare.pro4': 'Volume & brightness controls',
    'compare.pro5': 'Window Switcher (⌥Tab)',
    'compare.pro6': 'Drag shelf',
    'compare.pro7': 'Active window highlight',
    'compare.pro8': 'Calendar events, menu bar event display',
    'compare.pro9': 'Bar height / width and layout options',
    ...
    'faq.a1': 'No need to choose. Use both, or hide the Dock and make the taskbar your home base — whichever feels natural after Windows.',
  ...
  ja: {
    ...
    'pricing.sub': 'まず慣れた操作感で10日間。その後も Free で基本のタスクバーは継続できます。Pro は契約で解除できます。',
    'compare.title': 'Free と Pro',
    'compare.freeLabel': 'Free',
    'compare.freeNote': 'トライアル後・未購入でも、基本のタスクバーは継続利用できます。',
    ...
    'compare.pro2': 'システム操作アイコン、未読バッジ、Chrome プロファイル',
    'compare.pro3': 'メディアコントロール',
    'compare.pro4': '音量、明るさ調整',
    'compare.pro5': 'Window Switcher（⌥Tab）',
    'compare.pro6': 'ドラッグシェルフ',
    'compare.pro7': 'アクティブウィンドウ強調',
    'compare.pro8': 'カレンダー予定、メニューバー予定表示',
    'compare.pro9': 'バーの高さ・幅などレイアウト調整',
    'pricing.monthly': '月額',
    'pricing.yearly': '年額',
    ...
    'faq.a1': 'どちらか一方にする必要はありません。Dockと併用も、Dockを隠してタスクバー中心にすることもできます。Windowsのあとでしっくりくる方を選べます。',
